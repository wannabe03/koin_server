...
@Entity
@Table(
        name = "Koin_CommentReplyTable",
        indexes = {
                @Index(name = "idx_comment_reply_parent_id", columnList = "parent_comment_id"),
                @Index(name = "idx_comment_reply_created_at", columnList = "createdAt"),
